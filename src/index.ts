...
export class FewchaWallet implements AdapterPlugin {
  readonly name = FewchaWalletName; // CHANGE FewchaWalletName
  ...
  provider: IWeb3Provider | undefined =
    typeof window !== "undefined" ? window.fewcha : undefined; // CHANGE window.aptos
  ...
  async signAndSubmitTransaction(
    ...
    try {
      ...
      parseError(rawTransaction.status);
